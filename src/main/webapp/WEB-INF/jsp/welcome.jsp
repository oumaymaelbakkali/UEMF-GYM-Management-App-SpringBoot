...
<head>
     ...
     <!-- MAIN CSS -->
     <link rel="stylesheet" href="resources/css/tooplate-gymso-style.css">
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <a href="/login" class="btn custom-btn bordered mt-3" data-aos="fade-up" data-aos-delay="700">Get Reservation</a>
                    ...
                    <div class="row">
                            ...
                            <div class="ml-lg-auto col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="700">
                                <div class="team-thumb">
                                    <img src="resources/images/team/tem2.jpg" class="img-fluid" alt="Trainer">
                            ...
                            <div class="mr-lg-auto mt-5 mt-lg-0 mt-md-0 col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="800">
                                <div class="team-thumb">
                                    <img src="resources/images/team/team-image.jpg" class="img-fluid" alt="Trainer">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="class-thumb">
                                    <img src="resources/images/class/yoga-class.jpg" class="img-fluid" alt="Class">
                            ...
                            <div class="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                                <div class="class-thumb">
                                    <img src="resources/images/class/crossfit-class.jpg" class="img-fluid" alt="Class">
                            ...
                            <div class="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                                <div class="class-thumb">
                                    <img src="resources/images/class/cardio-class.jpg" class="img-fluid" alt="Class">
